...
const CommunityForum = () => {
  ...
  return (
    <div className="community-forum p-4 bg-gray-900 text-white">
        <h2 className="text-xl md:3xl font-bold mb-4 text-center my-10">Discussion</h2>
      ...
      <div className="threads-list  rounded-xl border-0  max-w-xl bg-gray-800 p-5">
        {threads.map((thread) => (
          ...
          >
            <h3 className="text-sm md:text-xl font-bold mb-2">{thread.title}</h3>
            <p className="text-xs md:text-lg text-gray-400 mb-1">{thread.content}</p>
