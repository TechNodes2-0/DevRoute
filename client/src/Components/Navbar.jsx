      ...
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-gray-900 border-b border-gray-700 text-sm py-2.5 sm:py-4">
        ...
        >
          ...
          <div className="flex flex-row items-center justify-end gap-2">
            ...
            {dropdownVisible && (
              <div className="relative">
              <div className="hs-dropdown absolute z-10 right-0 top-10 inline-flex flex-col gap-2 text-gray-800 bg-gray-900 border-0 rounded-xl">
                <div className="py-2 px-3 bg-gray-100 rounded-t-lg">
